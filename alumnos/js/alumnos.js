(function () {
    $(document).ready(function () {
        ...
        $("#click").click(function () {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == "0") {                        
                        document.getElementById("tituloAlumno").innerHTML = "ERROR";
                        document.getElementById("tituloAlumno").style.color = "red";
                        document.getElementById("textoModal").innerHTML = "No se pudo hacer el registro el usuario !YA EXISTE¡";
                        $("#formularioR-alumnos").slideUp('1000');                        
                        document.querySelectorAll(".arreglo")[3].setAttribute('style', 'display:block');
                        $("#formularioR-alumnos").slideDown('1000');
        ...
        var contador = 0;
        var mensajeAlumno = document.querySelector("#mensajesAplication");
        var instanceClassmate = M.Modal.init(mensajeAlumno, {});
            ...
            fetch('./login.php', {
                ...
                .then(respuesta => {
                    if (respuesta == 'true') {
                        ...
                        document.getElementById("tituloAlumno").innerHTML = "ERROR";
                        document.getElementById("tituloAlumno").style.color = "red";
                        document.getElementById("textoModal").innerHTML = "La contraseña y/o usuario son incorrectos";
                        instanceClassmate.open();
                    }
                })
        })
